...
/// @dev Set ASSETS env var: comma-separated ERC20 addresses (1-9 supported).
...
contract Deploy is Script {
    ...
    function run() public returns (address pasanaku) {
        ...
        require(assetsRaw.length <= SUPPORTED_ASSETS_COUNT, "Deploy: max 9 assets supported");
        ...
        vm.startBroadcast();
        pasanaku = address(new Pasanaku(assets));
        vm.stopBroadcast();
